...
public class ControllerImpl implements Controller {
    ...
    public String addAnimal(String areaName, String animalType, String animalName, String kind, double price) {
        ...
        boolean areaAndAndAnimalAreLandBase = areaType.equals("LandArea") && animalType.equals("TerrestrialAnimal");
        boolean areaAndAnimalAreWaterBased = areaType.equals("WaterArea") && animalType.equals("AquaticAnimal");
        if (areaAndAndAnimalAreLandBase || areaAndAnimalAreWaterBased) {
